  ...
  <section class="ark-hero" id="home-section">
    <div class="ark-container">
      <div class="ark-hero-grid">
        ...
        <div class="ark-hero-side reveal-block">
          <div class="ark-hero-panel">
          ...
          <div class="ark-avatar-wrap">
          <!--
            Avatar slot — pure CSS morphing blob by default.
            To replace with a Spline 3D scene:
              1. In Spline, click Export → Embed → Copy URL
              2. Replace the <div class="ark-blob">…</div> block below with:
                 <iframe src="YOUR_SPLINE_URL" width="100%" height="100%" frameborder="0" style="border-radius:28px;"></iframe>
              3. Remove the .ark-blob and .ark-ring CSS from styles.scss
          -->
          <div class="ark-blob">
            <div class="ark-blob-shape"></div>
            <div class="ark-blob-shape ark-blob-shape--2"></div>
            <div class="ark-blob-shape ark-blob-shape--3"></div>
          </div>
          <svg class="ark-ring" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="100" cy="100" r="85" stroke="rgba(193,18,31,0.12)" stroke-width="1" stroke-dasharray="4 8"/>
            <circle cx="100" cy="100" r="70" stroke="rgba(193,18,31,0.08)" stroke-width="0.5" stroke-dasharray="2 6"/>
          </svg>
          <div class="ark-ring-dot"></div>
          <div class="ark-ring-dot ark-ring-dot--2"></div>
          <div class="ark-ring-dot ark-ring-dot--3"></div>
        </div>
        </div>
      </div>
